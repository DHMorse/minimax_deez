make it so that when you challende eli bot instead of using random choice, it uses a minimax algrothim to make a really smart choice and become UBBEATABLE!!!
